...
public class RVTHelperRole2 extends ItemTouchHelper.SimpleCallback{
    Role2Adapter2 adapter;

    public RVTHelperRole2(Role2Adapter2 adapter) {
...
//            Toast.makeText(adapter.getContext(), "Edit record - "+position, Toast.LENGTH_SHORT).show();
